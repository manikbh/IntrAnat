...
class ImageImport (QtGui.QDialog):
    ...
    def __init__ (self, app=None):
        ...
        self.ui.tabWidget.currentChanged.connect(self.analyseBrainvisaDB)
        self.ui.tabWidget.currentChanged.connect(self.setTabGuide)
        # TAB1: Database
        ...
        self.ui.bvSubjectCombo.activated.connect(self.setCurrentSubject)
        ...
        # TAB2: Add subject
        self.ui.subjectSiteCombo.activated.connect(self.updatePatientCode)
        self.ui.subjectSiteCombo.editTextChanged.connect(self.updatePatientCode)
        self.ui.subjectYearSpinbox.valueChanged.connect(self.updatePatientCode)
        self.ui.subjectPatientName.textChanged.connect(self.updatePatientCode)
        self.ui.subjectPatientFirstName.textChanged.connect(self.updatePatientCode)
        ...
        self.ui.patProtocolCombo.activated.connect(lambda :pathologypatientinfo.buildUI(self.ui.patpatGroupBox,self.currentProtocol)) #lambda :pathologypatientinfo.buildUI(self.ui.patpatGroupBox,self.currentProtocol)) self._pathologyinfo(self.ui.patpatGroupBox,self.currentProtocol)
        self.ui.patSubjectCombo.currentIndexChanged[str].connect(self.selectPatSubject)
        self.ui.patSubjectCombo.activated.connect(self.setCurrentSubject)
        ...
        self.ui.niftiSubjectCombo.activated.connect(self.setCurrentSubject)
        ...
        self.ui.regSubjectCombo.activated.connect(self.setCurrentSubject)
